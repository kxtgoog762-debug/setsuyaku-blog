...
{{< chat speaker="manabu" >}}
4ステップだけなんですね。もっと役所の手続きみたいなのを想像してました。
{{< /chat >}}

{{< chat speaker="yattokame" >}}
実際はネット通販とほぼ同じ感覚だよ。あとは「どのサイトで買うか」だけ。主要3サイトの違いを見せるね。
{{< /chat >}}
...
※ 独身・扶養なし・住宅ローン控除等なしの目安（総務省の目安表ベース）。正確な金額は各サイトのシミュレーターで確認してください。上限ぴったりより**少し余裕を持って寄附する**と超過リスクがありません。
...
ふるさと納税はやらないと完全に損する制度です。年収300万円でも約2.8万円分の寄附ができ、実質2,000円で豪華な返礼品がもらえます。
